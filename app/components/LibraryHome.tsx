...
export default function LibraryHome({ books }: { books: Book[] }) {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden font-gaegu">
      ...
      <div className="relative bg-[#63d1e0]">
        ...
        <section className="relative px-5 pb-10 pt-16 sm:px-8 sm:pb-14 sm:pt-20">
          <div className="mx-auto max-w-5xl text-center">
            ...
            {/* SUBTITLE */}
            <p className="mt-4 text-l text-[#1F2A44] sm:text-xl">
              우리들의 새로운 궤도를 찾아서!
            </p>

            <p className="font-basic mt-2 text-lg text-[#1F2A44]/80 sm:text-xl">
        ...
        <div className="px-5 pb-0">
          <div className="mx-auto h-[3px] w-full max-w-5xl bg-[#FCF057]" />
        </div>
